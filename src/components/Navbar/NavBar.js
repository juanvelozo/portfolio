...
export const NavBar = () => {
  ...
  return (
    <>
      <nav className="h-auto p-4 flex mobile:relative justify-around mobile:justify-between mobile:px-10 items-center dark:bg-black dark:text-gray-50 font-lato">
        {/* burger button */}
        ...
        <Link
          to="/"
          className="font-bold text-2xl mobile:text-4xl md:hidden"
          onClick={() => {
            setOpen(false);
          }}
        >
        ...
        {/* navbar desktop */}
        <div className="flex w-full justify-around items-center mobile:hidden select-none">
          <Link to="/" className="font-bold text-2xl">
            JV
          </Link>
          <Link to="/portfolio" className=" text-xl font-light">
            {text.navbar.links[0]}
          </Link>
          <Link to="/about" className=" text-xl font-light">
            {text.navbar.links[1]}
          </Link>
          <Link to="/contact" className=" text-xl font-light">
            {text.navbar.links[2]}
          </Link>
